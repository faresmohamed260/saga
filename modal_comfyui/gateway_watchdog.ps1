...
$gatewayScript = Join-Path $projectRoot "modal_comfyui\run_gateway.py"
$stateDir = Join-Path $projectRoot "modal_comfyui"
...
function Get-GatewayProcesses {
    Get-CimInstance Win32_Process |
        Where-Object {
            $_.CommandLine -like '*modal_comfyui\run_gateway.py*' -and
