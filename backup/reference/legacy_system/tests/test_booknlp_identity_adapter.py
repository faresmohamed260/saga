...
def test_booknlp_identity_cleanup_llm_review_merges_low_count_short_variant(tmp_path: Path, monkeypatch) -> None:
    from saga.providers import reasoning_runtime_adapter as runtime_module
    ...
    monkeypatch.setattr(runtime_module, "create_runtime_client", lambda **kwargs: StubLLMClient(**kwargs))
