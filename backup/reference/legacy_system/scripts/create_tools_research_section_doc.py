...
SECTION_CONTENT: list[tuple[str, str]] = [
    ...
    (
        ...
        "In the current system, model choice is abstracted through the reasoning runtime layer instead of being hardwired into the architecture. This allows planning, prose generation, and analysis workloads to use different providers as reliability, cost, and quality requirements evolve. This provider-agnostic design better reflects the production path of S.A.G.A. than the earlier prototype's fixed-model framing.",
    ),
    (
