...
from saga.agents.scene_contract_reconciler import reconcile_scene_contract
...
from saga.domain.timeline.character_normalizer import CharacterNormalizer
...
def build_event_ledger(scene_analyses: List[Dict], timeline: List[Dict], causal_graph_result: Dict) -> List[Dict]:
    return EventLedgerBuilder().build(
...
def build_formal_character_profiles(
    ...
    return CharacterProfileBuilder().build(
