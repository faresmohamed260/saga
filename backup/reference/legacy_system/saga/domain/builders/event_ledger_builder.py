...
from saga.domain.normalization.helpers import dedupe_strings
        ...
        *,
        ...
        for row in sorted(timeline, key=lambda item: item.get("time_index", 0)):
            ...
            output.append({
                ...
                "type": str(row.get("event_type") or row.get("type") or "").strip(),
                ...
                "entities_involved": dedupe_strings(row.get("entities_involved") or []),
