...
class RelationalHybridRetrievalService:
    """
    Hybrid retrieval backend that combines:
    - dense cosine retrieval
    - lightweight BM25-style lexical retrieval
    - reciprocal-rank fusion
    - reranking when the cross-encoder is available
    """
    ...
    def __init__(
        ...
        *,
        ...
        self.sqlite_store = sqlite_store or SagaRelationalStore()
    ...
    def ensure_book_index(
        ...
        *,
        ...
        with self.sqlite_store.session_factory() as session:
            ...
            session.commit()
        LOGGER.info(
            "Relational hybrid retrieval index ready | book=%s model=%s docs=%s created=%s updated=%s removed=%s",
            book_id,
...
SQLiteHybridRetrievalService = RelationalHybridRetrievalService
