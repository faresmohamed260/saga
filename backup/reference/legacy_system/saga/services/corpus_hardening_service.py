...
from saga.providers.neo4j_ingestion_service import Neo4jIngestionService
...
class CorpusHardeningService:
    ...
    def __init__(
        ...
        *,
        ...
        vector_index_service: Optional[DocumentRetrievalTool] = None,
    ) -> None:
        self.neo4j = neo4j_service or Neo4jIngestionService()
        self.llm = llm_client
        self.wiki_hints_enabled = wiki_hints_enabled
        self.vector_index_service = vector_index_service or RetrievalService()
    ...
    def rebuild_corpus(
        ...
        *,
        ...
        index_payload = self.vector_index_service.ensure_document_index(
            series_id=series_id,
    ...
    def _recover_contract_from_source(
        ...
        *,
        ...
        raise RuntimeError(
            "Legacy contract recovery from source was removed. "
            "Use the DB-native ingestion and analysis agents instead."
        )
