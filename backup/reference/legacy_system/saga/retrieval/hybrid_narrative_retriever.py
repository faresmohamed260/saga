...
class HybridNarrativeRetriever:
    ...
    def __init__(self, *, index_service: Optional[DocumentRetrievalTool] = None) -> None:
        self.index_service = index_service or RetrievalService()
    ...
    def build_outline_context_packet(
        ...
        *,
        ...
        index_ref = self._ensure_index(retrieval_context)
        ...
        retrieved_items = self.index_service.query_documents(
            index_ref=index_ref,
    ...
    def _ensure_index(self, retrieval_context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return self.index_service.ensure_document_index(
