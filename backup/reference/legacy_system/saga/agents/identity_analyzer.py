...
from saga.agents.evidence_schema import compact_evidence_bundle, normalize_evidence_bundle
from saga.agents.tool_runtime import SceneToolRuntime
...
class IdentityAnalyzer:
    ...
    def __init__(self, llm_client: Optional[ReasoningClient] = None, max_attempts: int = 2):
    ...
    def _build_prompt(
        ...
        if getattr(self.llm, "mode", "") == MODE_GENERAL_COMPUTE:
            return f"""
