...
def test_sqlite_semantic_retrieval_indexes_and_queries_db_rows(tmp_path: Path) -> None:
    ...
    service = SQLiteSemanticRetrievalService(sqlite_store=store, embedder=_stub_embedder)
