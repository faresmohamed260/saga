...
from core.trait_taxonomy import TYPED_ATTRIBUTE_KEYS, practical_persistent_fields
from infrastructure.llm_client import LLMClient
from sql_store.models import Book, Entity, Event, Scene
...
Hard rules:
- `baseline_description` should be a compact but vivid prose description of the entity's stable visual identity.
