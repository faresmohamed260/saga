...
export const MODEL_ADVANCED_PRESETS = Object.freeze({
  ...
  'qwen-image-edit-2511': Object.freeze({
    ...
    modelLabel: 'Qwen Image Edit 2511 · Abliterated BF16 + Lightning',
    workflowId: 'qwen-image-edit-2511',
    workflowLabel: 'Qwen Image Edit 2511 · Abliterated + Lightning',
    seed: '42',
    steps: 4,
    cfg: 1.0,
    negativePrompt: '',
    stepsEditable: true,
    stepsDetail: '4-step tuned default · editable 1–50',
  }),
