...
export function SignUpPage() {
  ...
  return (
    ...
    >
      {createdUser ? (
        <div role="status" className="rounded-lg border border-emerald-300/28 bg-emerald-300/[0.08] p-5">
          ...
          <Link to="/overview" className="mt-5 inline-flex min-h-11 items-center justify-center rounded-lg border border-emerald-200/55 bg-emerald-300/[0.16] px-4 py-2 text-sm font-bold text-emerald-50 transition hover:bg-emerald-300/[0.24]">
            Open studio
          </Link>
        </div>
      ) : (
