...
from saga.agents.evidence_schema import normalize_evidence_bundle
...
class IdentitySemanticReviewer:
    ...
    def _validate_canonical_character(self, character: Dict, scene_text: str) -> Dict:
        ...
        prompt = f"""
Task: validate whether this scene-level canonical character should remain a consequential character saga.identity.
